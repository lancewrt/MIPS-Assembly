# Title: Performing Multiplication Instruction 
# Author: Lance Bernal
# Date: 11-09-2022
# Description: Perform multiplication instruction and check the value of HI and LO registers
# Input: None
...
main:					# main function entry
   ...
   li $s0, -98765			# load to $s0 the given number (-98765)
   li $s1, -54321			# load to $s1 the given number (-54321)
   #multu $s0, $s1			# multiply the value of $s1 and $s0
   mult $s0, $s1			# multiply the value of $s1 and $s0
